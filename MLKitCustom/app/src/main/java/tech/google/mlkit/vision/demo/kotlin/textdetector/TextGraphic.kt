...
package tech.google.mlkit.vision.demo.kotlin.textdetector
 ...
 * overlay view.
 */
class TextGraphic constructor(overlay: _root_ide_package_.tech.google.mlkit.vision.demo.GraphicOverlay?, private val text: Text) :
        Graphic(overlay) {
