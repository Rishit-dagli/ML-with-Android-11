...
package tech.google.mlkit.vision.demo.kotlin.automl
...
import tech.google.mlkit.vision.demo.automl.LabelGraphic
...
class AutoMLImageLabelerProcessor(context: Context) :
    ...
    override fun onSuccess(results: List<ImageLabel>, graphicOverlay: _root_ide_package_.tech.google.mlkit.vision.demo.GraphicOverlay) {
        graphicOverlay.add(
            _root_ide_package_.tech.google.mlkit.vision.demo.automl.LabelGraphic(
                graphicOverlay,
                results
            )
        )
