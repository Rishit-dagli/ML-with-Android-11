...
package tech.google.mlkit.vision.demo.kotlin.labeldetector
...
import tech.google.mlkit.vision.demo.labeldetector.LabelGraphic
...
class LabelDetectorProcessor(context: Context, options: ImageLabelerOptionsBase) :
    ...
    override fun onSuccess(labels: List<ImageLabel>, graphicOverlay: _root_ide_package_.tech.google.mlkit.vision.demo.GraphicOverlay) {
        graphicOverlay.add(
            _root_ide_package_.tech.google.mlkit.vision.demo.labeldetector.LabelGraphic(
                graphicOverlay,
                labels
            )
        )
